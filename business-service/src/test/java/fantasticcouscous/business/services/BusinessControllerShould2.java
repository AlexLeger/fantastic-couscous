...
import fantasticcouscous.business.controller.BusinessController;
import feign.Feign;
...
@Slf4j
public class BusinessControllerShould2 {
    ...
    public void setup(){
            ...
            UserServiceProxy userServiceProxy = Feign.builder()
                    ...
                    BusinessService businessService = new BusinessService(userServiceProxy);
    ...
    String login ="jmcclane";
        String result = businessController.getBusinessInfo(login);
    ...
    public void hitCache(){
        ...
        //First call
        String result1 = businessController.getBusinessInfo(login);

        //Second call
        String result2 = businessController.getBusinessInfo(login);
