...
public class MyCustomRemoteEventListener implements ApplicationListener<MyCustomRemoteEvent> {
    ...
    public void onApplicationEvent(MyCustomRemoteEvent myCustomRemoteEvent) {
        logger.info("Received MyCustomRemoteEvent - message: " + myCustomRemoteEvent.getMessage() + "from source : "+myCustomRemoteEvent.getSource() + " origin service : " + myCustomRemoteEvent.getOriginService());
    }
}
